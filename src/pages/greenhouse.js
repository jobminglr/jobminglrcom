            ...
            <div className="mt-4 space-y-3">
              ...
              <details className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="mt-3 text-sm text-gray-700 space-y-2">
                  ...
                  <p>
                    In Greenhouse, go to <strong>Configure ⚙️ → Job Board</strong>. Select the job board you use for external postings.
                  </p>
              ...
              <details className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="mt-3 text-sm text-gray-700 space-y-2">
                  ...
                  <p>
                    In Greenhouse, go to <strong>Configure ⚙️ → Users</strong>. Find and click the user who created your API Key.
                  </p>
